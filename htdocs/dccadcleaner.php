...
<HTML>
  <HEAD>
    <TITLE>DC CAD Cleaner Extension</TITLE>
...
<h1 class="headline">DC CAD Cleaner Extension</h1>
      
      <p>The DC Cleaner Extension adds functionality to remove CAD drawing
      artifacts in ArcView 3.x. 
	...
	<p>The software is part of the <a href="index.php" class="copylink"
      ...
      <p>A summary of features is available in the <a href=
        "dccadcleaner_flyer.pdf" class="copylink">flyer</a> (PDF).</p>
	...
	if(strpos($item["title"], "cadcleaner") > 0) { ?>
          <h3 class="subnavihead"><?php echo str_replace("dccadcleaner", "DC CAD Cleaner Extension",
	    $item["title"]); ?></h3>
